...
**TokenizationSpoke:** Spoke variant that exposes only the supply side of the protocol via an ERC-4626 interface. Has no borrow surface and no risk premium calculation; positions through the TokenizationSpoke are supply-only.
