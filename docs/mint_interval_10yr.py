...
for bar, val in zip(bars, interests):
    ax.text(bar.get_x() + bar.get_width()/2, bar.get_height() + 150_000,
            f"${val:,.0f}", ha="center", va="bottom", fontsize=8, fontweight="bold")

ax.set_ylabel("Total Interest Earned Over 10 Years (USD)", fontsize=12)
ax.set_xlabel("Minting Interval", fontsize=12)
ax.set_title(
    "Treasury Interest Earned by mintFeeShares() Frequency (10-Year Horizon)\n"
...
plt.tight_layout()
plt.savefig("docs/mint_interval_interest_10yr.png", dpi=150)
print("Saved docs/mint_interval_interest_10yr.png")
