...
def verify_roles(
    ...
    # HUB_CONFIGURATOR_DOMAIN_ADMIN_ROLE (200) -> HubConfigurator should be member
    grant_calls.append((
        "HUB_CONFIGURATOR_DOMAIN_ADMIN_ROLE/HubConfigurator",
        am_contract.functions.hasRole(200, hc_target),
    ))
    grant_expectations.append(("HUB_CONFIGURATOR_DOMAIN_ADMIN_ROLE/HubConfigurator", "HubConfigurator is member"))

    # SPOKE_CONFIGURATOR_DOMAIN_ADMIN_ROLE (400) -> SpokeConfigurator should be member
    grant_calls.append((
        "SPOKE_CONFIGURATOR_DOMAIN_ADMIN_ROLE/SpokeConfigurator",
        am_contract.functions.hasRole(400, sc_target),
    ))
    grant_expectations.append(("SPOKE_CONFIGURATOR_DOMAIN_ADMIN_ROLE/SpokeConfigurator", "SpokeConfigurator is member"))
