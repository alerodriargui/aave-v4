...
describe('unit', () => {
  ...
  test('6 supply yields -1 bc of index', () => {
  ...
  test('7 underflow bc sum of scaled may not to equate to individual scaled when all are unscaled', () => {
