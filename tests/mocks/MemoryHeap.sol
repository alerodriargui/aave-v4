...
// // lib/oz/contracts/utils/Comparators.sol
...
// // lib/oz/contracts/utils/Panic.sol
...
// // lib/oz/contracts/utils/SlotDerivation.sol
...
// // lib/oz/contracts/utils/StorageSlot.sol
...
// // lib/oz/contracts/utils/math/SafeCast.sol
...
// // lib/oz/contracts/utils/math/Math.sol
...
// // lib/oz/contracts/utils/Arrays.sol
...
// // lib/oz/contracts/utils/structs/Heap.sol
...
//    */
//   function length(Uint256Heap memory self) internal view returns (uint256) {
...
//    */
//   function clear(Uint256Heap memory self) internal {
//     self.tree.length = 0;
//   }
...
//    */
//   function _swap(Uint256Heap memory self, uint256 i, uint256 j) private {
//     StorageSlot.Uint256Slot memory ni = self.tree[i];
//     StorageSlot.Uint256Slot memory nj = self.tree[j];
...
//       if (rIndex < size) {
//         uint256 lValue = self.tree[lIndex];
//         uint256 rValue = self.tree[rIndex];
