...
import {PackedSortedKeyListSstore2} from 'src/libraries/PackedSortedKeyListSstore2.sol';
...
contract Wrapper is IWrapper {
  using PackedSortedKeyListSstore2 for PackedSortedKeyListSstore2.KeyList;
  using PackedSortedKeyListSstore2 for PackedSortedKeyListSstore2.ValueMap;

  PackedSortedKeyListSstore2.KeyList internal list;
  PackedSortedKeyListSstore2.ValueMap internal map;
...
contract PackedSortedKeyListSstore2Test is Test {
  uint256 internal constant MAX_KEY = 1 << 10;
