...
contract ReplayTest6 is Invariants, Setup {
    ...
    function test_replay_6_repay() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_6_withdraw() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_6_updateUserRiskPremium() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_6_setUsingAsCollateral() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_6_setPrice() public {
        _setUpActor(USER1);
        _delay(586107);
    ...
    function test_replay_6_transfer() public {
        _setUpActor(USER1);
        _delay(360520);
