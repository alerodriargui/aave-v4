...
contract ReplayTest4 is Invariants, Setup {
    ...
    function test_replay_4_liquidationCall() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_4_updateUserDynamicConfig() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_4_repay() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_4_updateUserRiskPremium() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_4_setUsingAsCollateral() public {
        _setUpActor(USER1);
        _delay(228361);
    ...
    function test_replay_4_setPrice() public {
        _setUpActor(USER1);
        _delay(586107);
    ...
    function test_replay_4_transfer() public {
        _setUpActor(USER1);
        _delay(360520);
