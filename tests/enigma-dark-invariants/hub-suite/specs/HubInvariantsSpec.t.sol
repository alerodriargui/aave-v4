...
abstract contract HubInvariantsSpec is InvariantsSpec {
    ...
    string constant INV_HUB_AVAILABILITY_C = "INV_HUB_AVAILABILITY_C: getAssetTotalOwed must not revert";

    string constant INV_HUB_AVAILABILITY_D = "INV_HUB_AVAILABILITY_D: getAssetPremiumRay must not revert";

    string constant INV_HUB_AVAILABILITY_E = "INV_HUB_AVAILABILITY_E: getAssetAccruedFees must not revert";

    string constant INV_HUB_AVAILABILITY_F = "INV_HUB_AVAILABILITY_F: getSpokeAddedAssets must not revert";

    string constant INV_HUB_AVAILABILITY_G = "INV_HUB_AVAILABILITY_G: getSpokeOwed must not revert";

    string constant INV_HUB_AVAILABILITY_H = "INV_HUB_AVAILABILITY_H: getSpokeTotalOwed must not revert";

    string constant INV_HUB_AVAILABILITY_I = "INV_HUB_AVAILABILITY_I: getSpokePremiumRay must not revert";
}
