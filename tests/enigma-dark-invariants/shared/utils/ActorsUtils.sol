...
library ActorsUtils {
    ...
    function setUpActors(address[] memory addresses, address[] memory tokens, address[] memory contracts)
        internal
        returns (address[] memory actorAddresses)
    {
    ...
    function setUpActor(address[] memory tokens, address[] memory contracts) internal returns (address actorAddress) {
        bool success;
