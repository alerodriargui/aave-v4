...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashPositionManagerUpdate_EIP712HashCorrect_revert;
    bool hashPositionManagerUpdate_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashPositionManagerUpdate_EIP712HashCorrect; calldataarg args;
    env e_hashPositionManagerUpdate_EIP712HashOptimized;
    e_equivalence(e_hashPositionManagerUpdate_EIP712HashCorrect, e_hashPositionManagerUpdate_EIP712HashOptimized);

    hashPositionManagerUpdate@withrevert(e_hashPositionManagerUpdate_EIP712HashCorrect, args);
    hashPositionManagerUpdate_EIP712HashCorrect_revert = lastReverted;

    B.hashPositionManagerUpdate@withrevert(e_hashPositionManagerUpdate_EIP712HashOptimized, args) at init;
    hashPositionManagerUpdate_EIP712HashOptimized_revert = lastReverted;

    assert(hashPositionManagerUpdate_EIP712HashCorrect_revert == hashPositionManagerUpdate_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashPositionManagerUpdate_EIP712HashCorrect_bytes32_out0;
    bytes32 hashPositionManagerUpdate_EIP712HashOptimized_bytes32_out0;
    ...
    hashPositionManagerUpdate_EIP712HashCorrect_bytes32_out0 = hashPositionManagerUpdate(e_hashPositionManagerUpdate_EIP712HashCorrect, args);
    hashPositionManagerUpdate_EIP712HashOptimized_bytes32_out0 = B.hashPositionManagerUpdate(e_hashPositionManagerUpdate_EIP712HashOptimized, args) at init;

    assert(hashPositionManagerUpdate_EIP712HashCorrect_bytes32_out0 == hashPositionManagerUpdate_EIP712HashOptimized_bytes32_out0);
}
