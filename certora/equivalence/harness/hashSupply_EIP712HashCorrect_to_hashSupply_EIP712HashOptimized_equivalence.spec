...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashSupply_EIP712HashCorrect_revert;
    bool hashSupply_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashSupply_EIP712HashCorrect; calldataarg args;
    env e_hashSupply_EIP712HashOptimized;
    e_equivalence(e_hashSupply_EIP712HashCorrect, e_hashSupply_EIP712HashOptimized);

    hashSupply@withrevert(e_hashSupply_EIP712HashCorrect, args);
    hashSupply_EIP712HashCorrect_revert = lastReverted;

    B.hashSupply@withrevert(e_hashSupply_EIP712HashOptimized, args) at init;
    hashSupply_EIP712HashOptimized_revert = lastReverted;

    assert(hashSupply_EIP712HashCorrect_revert == hashSupply_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashSupply_EIP712HashCorrect_bytes32_out0;
    bytes32 hashSupply_EIP712HashOptimized_bytes32_out0;
    ...
    hashSupply_EIP712HashCorrect_bytes32_out0 = hashSupply(e_hashSupply_EIP712HashCorrect, args);
    hashSupply_EIP712HashOptimized_bytes32_out0 = B.hashSupply(e_hashSupply_EIP712HashOptimized, args) at init;

    assert(hashSupply_EIP712HashCorrect_bytes32_out0 == hashSupply_EIP712HashOptimized_bytes32_out0);
}
