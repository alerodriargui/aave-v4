...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashSetUsingAsCollateral_EIP712HashCorrect_revert;
    bool hashSetUsingAsCollateral_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashSetUsingAsCollateral_EIP712HashCorrect; calldataarg args;
    env e_hashSetUsingAsCollateral_EIP712HashOptimized;
    e_equivalence(e_hashSetUsingAsCollateral_EIP712HashCorrect, e_hashSetUsingAsCollateral_EIP712HashOptimized);

    hashSetUsingAsCollateral@withrevert(e_hashSetUsingAsCollateral_EIP712HashCorrect, args);
    hashSetUsingAsCollateral_EIP712HashCorrect_revert = lastReverted;

    B.hashSetUsingAsCollateral@withrevert(e_hashSetUsingAsCollateral_EIP712HashOptimized, args) at init;
    hashSetUsingAsCollateral_EIP712HashOptimized_revert = lastReverted;

    assert(hashSetUsingAsCollateral_EIP712HashCorrect_revert == hashSetUsingAsCollateral_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashSetUsingAsCollateral_EIP712HashCorrect_bytes32_out0;
    bytes32 hashSetUsingAsCollateral_EIP712HashOptimized_bytes32_out0;
    ...
    hashSetUsingAsCollateral_EIP712HashCorrect_bytes32_out0 = hashSetUsingAsCollateral(e_hashSetUsingAsCollateral_EIP712HashCorrect, args);
    hashSetUsingAsCollateral_EIP712HashOptimized_bytes32_out0 = B.hashSetUsingAsCollateral(e_hashSetUsingAsCollateral_EIP712HashOptimized, args) at init;

    assert(hashSetUsingAsCollateral_EIP712HashCorrect_bytes32_out0 == hashSetUsingAsCollateral_EIP712HashOptimized_bytes32_out0);
}
