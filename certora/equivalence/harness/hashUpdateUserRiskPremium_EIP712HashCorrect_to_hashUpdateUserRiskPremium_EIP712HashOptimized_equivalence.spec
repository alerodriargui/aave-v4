...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashUpdateUserRiskPremium_EIP712HashCorrect_revert;
    bool hashUpdateUserRiskPremium_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashUpdateUserRiskPremium_EIP712HashCorrect; calldataarg args;
    env e_hashUpdateUserRiskPremium_EIP712HashOptimized;
    e_equivalence(e_hashUpdateUserRiskPremium_EIP712HashCorrect, e_hashUpdateUserRiskPremium_EIP712HashOptimized);

    hashUpdateUserRiskPremium@withrevert(e_hashUpdateUserRiskPremium_EIP712HashCorrect, args);
    hashUpdateUserRiskPremium_EIP712HashCorrect_revert = lastReverted;

    B.hashUpdateUserRiskPremium@withrevert(e_hashUpdateUserRiskPremium_EIP712HashOptimized, args) at init;
    hashUpdateUserRiskPremium_EIP712HashOptimized_revert = lastReverted;

    assert(hashUpdateUserRiskPremium_EIP712HashCorrect_revert == hashUpdateUserRiskPremium_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashUpdateUserRiskPremium_EIP712HashCorrect_bytes32_out0;
    bytes32 hashUpdateUserRiskPremium_EIP712HashOptimized_bytes32_out0;
    ...
    hashUpdateUserRiskPremium_EIP712HashCorrect_bytes32_out0 = hashUpdateUserRiskPremium(e_hashUpdateUserRiskPremium_EIP712HashCorrect, args);
    hashUpdateUserRiskPremium_EIP712HashOptimized_bytes32_out0 = B.hashUpdateUserRiskPremium(e_hashUpdateUserRiskPremium_EIP712HashOptimized, args) at init;

    assert(hashUpdateUserRiskPremium_EIP712HashCorrect_bytes32_out0 == hashUpdateUserRiskPremium_EIP712HashOptimized_bytes32_out0);
}
