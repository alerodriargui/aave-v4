...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashSetUserPositionManagers_EIP712HashCorrect_revert;
    bool hashSetUserPositionManagers_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashSetUserPositionManagers_EIP712HashCorrect; calldataarg args;
    env e_hashSetUserPositionManagers_EIP712HashOptimized;
    e_equivalence(e_hashSetUserPositionManagers_EIP712HashCorrect, e_hashSetUserPositionManagers_EIP712HashOptimized);

    hashSetUserPositionManagers@withrevert(e_hashSetUserPositionManagers_EIP712HashCorrect, args);
    hashSetUserPositionManagers_EIP712HashCorrect_revert = lastReverted;

    B.hashSetUserPositionManagers@withrevert(e_hashSetUserPositionManagers_EIP712HashOptimized, args) at init;
    hashSetUserPositionManagers_EIP712HashOptimized_revert = lastReverted;

    assert(hashSetUserPositionManagers_EIP712HashCorrect_revert == hashSetUserPositionManagers_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashSetUserPositionManagers_EIP712HashCorrect_bytes32_out0;
    bytes32 hashSetUserPositionManagers_EIP712HashOptimized_bytes32_out0;
    ...
    hashSetUserPositionManagers_EIP712HashCorrect_bytes32_out0 = hashSetUserPositionManagers(e_hashSetUserPositionManagers_EIP712HashCorrect, args);
    hashSetUserPositionManagers_EIP712HashOptimized_bytes32_out0 = B.hashSetUserPositionManagers(e_hashSetUserPositionManagers_EIP712HashOptimized, args) at init;

    assert(hashSetUserPositionManagers_EIP712HashCorrect_bytes32_out0 == hashSetUserPositionManagers_EIP712HashOptimized_bytes32_out0);
}
