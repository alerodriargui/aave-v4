...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashTokenizedDeposit_EIP712HashCorrect_revert;
    bool hashTokenizedDeposit_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashTokenizedDeposit_EIP712HashCorrect; calldataarg args;
    env e_hashTokenizedDeposit_EIP712HashOptimized;
    e_equivalence(e_hashTokenizedDeposit_EIP712HashCorrect, e_hashTokenizedDeposit_EIP712HashOptimized);

    hashTokenizedDeposit@withrevert(e_hashTokenizedDeposit_EIP712HashCorrect, args);
    hashTokenizedDeposit_EIP712HashCorrect_revert = lastReverted;

    B.hashTokenizedDeposit@withrevert(e_hashTokenizedDeposit_EIP712HashOptimized, args) at init;
    hashTokenizedDeposit_EIP712HashOptimized_revert = lastReverted;

    assert(hashTokenizedDeposit_EIP712HashCorrect_revert == hashTokenizedDeposit_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashTokenizedDeposit_EIP712HashCorrect_bytes32_out0;
    bytes32 hashTokenizedDeposit_EIP712HashOptimized_bytes32_out0;
    ...
    hashTokenizedDeposit_EIP712HashCorrect_bytes32_out0 = hashTokenizedDeposit(e_hashTokenizedDeposit_EIP712HashCorrect, args);
    hashTokenizedDeposit_EIP712HashOptimized_bytes32_out0 = B.hashTokenizedDeposit(e_hashTokenizedDeposit_EIP712HashOptimized, args) at init;

    assert(hashTokenizedDeposit_EIP712HashCorrect_bytes32_out0 == hashTokenizedDeposit_EIP712HashOptimized_bytes32_out0);
}
