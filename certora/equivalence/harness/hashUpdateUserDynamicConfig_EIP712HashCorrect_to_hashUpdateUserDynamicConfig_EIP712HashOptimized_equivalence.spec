...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashUpdateUserDynamicConfig_EIP712HashCorrect_revert;
    bool hashUpdateUserDynamicConfig_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashUpdateUserDynamicConfig_EIP712HashCorrect; calldataarg args;
    env e_hashUpdateUserDynamicConfig_EIP712HashOptimized;
    e_equivalence(e_hashUpdateUserDynamicConfig_EIP712HashCorrect, e_hashUpdateUserDynamicConfig_EIP712HashOptimized);

    hashUpdateUserDynamicConfig@withrevert(e_hashUpdateUserDynamicConfig_EIP712HashCorrect, args);
    hashUpdateUserDynamicConfig_EIP712HashCorrect_revert = lastReverted;

    B.hashUpdateUserDynamicConfig@withrevert(e_hashUpdateUserDynamicConfig_EIP712HashOptimized, args) at init;
    hashUpdateUserDynamicConfig_EIP712HashOptimized_revert = lastReverted;

    assert(hashUpdateUserDynamicConfig_EIP712HashCorrect_revert == hashUpdateUserDynamicConfig_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashUpdateUserDynamicConfig_EIP712HashCorrect_bytes32_out0;
    bytes32 hashUpdateUserDynamicConfig_EIP712HashOptimized_bytes32_out0;
    ...
    hashUpdateUserDynamicConfig_EIP712HashCorrect_bytes32_out0 = hashUpdateUserDynamicConfig(e_hashUpdateUserDynamicConfig_EIP712HashCorrect, args);
    hashUpdateUserDynamicConfig_EIP712HashOptimized_bytes32_out0 = B.hashUpdateUserDynamicConfig(e_hashUpdateUserDynamicConfig_EIP712HashOptimized, args) at init;

    assert(hashUpdateUserDynamicConfig_EIP712HashCorrect_bytes32_out0 == hashUpdateUserDynamicConfig_EIP712HashOptimized_bytes32_out0);
}
