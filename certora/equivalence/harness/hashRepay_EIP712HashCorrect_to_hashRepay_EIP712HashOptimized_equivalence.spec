...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashRepay_EIP712HashCorrect_revert;
    bool hashRepay_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashRepay_EIP712HashCorrect; calldataarg args;
    env e_hashRepay_EIP712HashOptimized;
    e_equivalence(e_hashRepay_EIP712HashCorrect, e_hashRepay_EIP712HashOptimized);

    hashRepay@withrevert(e_hashRepay_EIP712HashCorrect, args);
    hashRepay_EIP712HashCorrect_revert = lastReverted;

    B.hashRepay@withrevert(e_hashRepay_EIP712HashOptimized, args) at init;
    hashRepay_EIP712HashOptimized_revert = lastReverted;

    assert(hashRepay_EIP712HashCorrect_revert == hashRepay_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashRepay_EIP712HashCorrect_bytes32_out0;
    bytes32 hashRepay_EIP712HashOptimized_bytes32_out0;
    ...
    hashRepay_EIP712HashCorrect_bytes32_out0 = hashRepay(e_hashRepay_EIP712HashCorrect, args);
    hashRepay_EIP712HashOptimized_bytes32_out0 = B.hashRepay(e_hashRepay_EIP712HashOptimized, args) at init;

    assert(hashRepay_EIP712HashCorrect_bytes32_out0 == hashRepay_EIP712HashOptimized_bytes32_out0);
}
