...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashTokenizedRedeem_EIP712HashCorrect_revert;
    bool hashTokenizedRedeem_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashTokenizedRedeem_EIP712HashCorrect; calldataarg args;
    env e_hashTokenizedRedeem_EIP712HashOptimized;
    e_equivalence(e_hashTokenizedRedeem_EIP712HashCorrect, e_hashTokenizedRedeem_EIP712HashOptimized);

    hashTokenizedRedeem@withrevert(e_hashTokenizedRedeem_EIP712HashCorrect, args);
    hashTokenizedRedeem_EIP712HashCorrect_revert = lastReverted;

    B.hashTokenizedRedeem@withrevert(e_hashTokenizedRedeem_EIP712HashOptimized, args) at init;
    hashTokenizedRedeem_EIP712HashOptimized_revert = lastReverted;

    assert(hashTokenizedRedeem_EIP712HashCorrect_revert == hashTokenizedRedeem_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashTokenizedRedeem_EIP712HashCorrect_bytes32_out0;
    bytes32 hashTokenizedRedeem_EIP712HashOptimized_bytes32_out0;
    ...
    hashTokenizedRedeem_EIP712HashCorrect_bytes32_out0 = hashTokenizedRedeem(e_hashTokenizedRedeem_EIP712HashCorrect, args);
    hashTokenizedRedeem_EIP712HashOptimized_bytes32_out0 = B.hashTokenizedRedeem(e_hashTokenizedRedeem_EIP712HashOptimized, args) at init;

    assert(hashTokenizedRedeem_EIP712HashCorrect_bytes32_out0 == hashTokenizedRedeem_EIP712HashOptimized_bytes32_out0);
}
