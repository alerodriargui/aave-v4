...
rule equivalence_of_revert_conditions()
{
    ...
    bool hashTokenizedWithdraw_EIP712HashCorrect_revert;
    bool hashTokenizedWithdraw_EIP712HashOptimized_revert;
    // using this as opposed to generating input parameters is experimental
    env e_hashTokenizedWithdraw_EIP712HashCorrect; calldataarg args;
    env e_hashTokenizedWithdraw_EIP712HashOptimized;
    e_equivalence(e_hashTokenizedWithdraw_EIP712HashCorrect, e_hashTokenizedWithdraw_EIP712HashOptimized);

    hashTokenizedWithdraw@withrevert(e_hashTokenizedWithdraw_EIP712HashCorrect, args);
    hashTokenizedWithdraw_EIP712HashCorrect_revert = lastReverted;

    B.hashTokenizedWithdraw@withrevert(e_hashTokenizedWithdraw_EIP712HashOptimized, args) at init;
    hashTokenizedWithdraw_EIP712HashOptimized_revert = lastReverted;

    assert(hashTokenizedWithdraw_EIP712HashCorrect_revert == hashTokenizedWithdraw_EIP712HashOptimized_revert);
}
...
rule equivalence_of_return_value()
{
    storage init = lastStorage;
    assume_equivalent_states();
    bytes32 hashTokenizedWithdraw_EIP712HashCorrect_bytes32_out0;
    bytes32 hashTokenizedWithdraw_EIP712HashOptimized_bytes32_out0;
    ...
    hashTokenizedWithdraw_EIP712HashCorrect_bytes32_out0 = hashTokenizedWithdraw(e_hashTokenizedWithdraw_EIP712HashCorrect, args);
    hashTokenizedWithdraw_EIP712HashOptimized_bytes32_out0 = B.hashTokenizedWithdraw(e_hashTokenizedWithdraw_EIP712HashOptimized, args) at init;

    assert(hashTokenizedWithdraw_EIP712HashCorrect_bytes32_out0 == hashTokenizedWithdraw_EIP712HashOptimized_bytes32_out0);
}
